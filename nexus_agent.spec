...
for pkg in ['pydantic', 'pydantic_settings', 'cryptography', 'websockets', 'rich', 'click', 'pynput', 'mss', 'PIL', 'psutil', 'structlog']:
    d, b, h = collect_all(pkg)
    datas += d
    binaries += b
    hiddenimports += h
a = Analysis(
    ['C:/Users/ELAD DAUDET/Documents/projects/nexus-ras-v2/nexus_agent_entry.py'],
    ...
    hookspath=[],
    hooksconfig={},
    runtime_hooks=['C:/Users/ELAD DAUDET/Documents/projects/nexus-ras-v2/rth_openssl_fix.py'],
