...
for pkg in ['uvicorn', 'fastapi', 'starlette', 'pydantic', 'pydantic_settings', 'cryptography', 'websockets', 'rich', 'click', 'pynput', 'mss', 'PIL', 'psutil', 'structlog', 'aiosqlite', 'sqlalchemy', 'bcrypt', 'pyotp']:
    d, b, h = collect_all(pkg)
    datas += d
    binaries += b
    hiddenimports += h
a = Analysis(
    ['C:/Users/ELAD DAUDET/Documents/projects/nexus-ras-v2/setup_and_launch.py'],
